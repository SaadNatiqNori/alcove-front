    ...
    >
      ...
      >
        <main
          ...
          className="relative h-screen lg:h-full max-w-[1440px] mx-auto flex flex-col bg-[#E2EAF2] px-4 tablet:px-[39.83px] max-md:pb-[40px] tablet:[padding-bottom:min(41.4px,3.467vh)] max-md:[padding-top:min(196px,21.031vh)] tablet:[padding-top:min(238.88px,20.007vh)] text-[#1C2D4F] md:px-[38px] md:pb-[40px] md:pt-[200.69px]"
        >
